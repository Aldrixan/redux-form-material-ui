...
describe( "RadioGroup", () => {
    ...
    test( 'renders an RadioGroup', () => {
        act( () => {
            render( <ReduxFormMaterialUIRadioGroup input={{ onChange: noop, name: "myRadio" }} meta={{}}>
                <FormControlLabel
                    value="pickup"
                    control={<Radio />}
                    label="Pickup"
                ...
                <FormControlLabel
                    ...
                    label="Delivery"
                />
            </ReduxFormMaterialUIRadioGroup>, container );
        } )
    ...
    test( 'renders a RadioGroup with value', () => {
        act( () => {
            render( <ReduxFormMaterialUIRadioGroup input={{ onChange: noop, name: "myRadio", value: "pickup" }} meta={{}}>
                <FormControlLabel
                    value="pickup"
                    control={<Radio />}
                    label="Pickup"
    ...
    test( 'renders a RadioGroup with helper text when not touched', () => {
        act( () => {
            render( <ReduxFormMaterialUIRadioGroup input={{ onChange: noop, name: "myRadio", value: "Foo" }} meta={{}}
    ...
    test( 'renders a RadioGroup with error when touched', () => {
        act( () => {
            render( <ReduxFormMaterialUIRadioGroup
    ...
    test( "should ignore defaultValue", () => {
        act( () => {
            render( <ReduxFormMaterialUIRadioGroup input={{ onChange: noop, name: "myRadio", value: "Foo" }} defaultValue='pickup' meta={{}}>
                <FormControlLabel
                    value="pickup"
                    control={<Radio />}
                    label="Pickup"
